import { defaultTailwindFontFamilies, defaultTailwindFontSizes, defaultTailwindFontWeights, } from "dslinter";
/**
 * Mirrors `@theme` in `src/index.css` + `dslinter/theme.css` for the dashboard token wall.
