...
export function SmellyInput() {
    ...
    return (<div className={`space-y-3 rounded border border-dashed text-[#000000] border-amber-400 p-3 text-xs ${tailwindArbitraryDemo}`}>
      ...
      <>
        <div className="space-y-2">
          ...
          <KitchenSinkModal title="Smell" subtitle="Kitchen sink" icon="⚠️" confirmLabel="OK" cancelLabel="Cancel" width="max-w-md" dismissible initialFocus="confirm" bannerTone="warning" footerAlign="end" scrollLock overlayBlur analyticsId="smelly-input" testId="smelly-modal" role="dialog" portal/>
          ...
          {/* a11y-img-alt */}
          <img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width={16} height={16} className="inline-block"/>
