...
export const playgroundControls: PlaygroundControl[] = [
  ...
  { key: "subtitle", label: "subtitle", type: "string", default: "Choose how we contact you about updates." },
  ...
  { key: "analyticsId", label: "analyticsId", type: "string", default: "notification-settings-modal" },
