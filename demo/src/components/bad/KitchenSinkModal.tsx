...
export const { playgroundMeta, playgroundControls, PlaygroundPreview } = definePlayground(KitchenSinkModal, {
  section: "bad",
  description: "Large prop surface — variant explosion when fully exercised from JSX.",
  controls: [
    { key: "title", label: "title", type: "string", default: "Kitchen sink" },
    { key: "subtitle", label: "subtitle", type: "string", default: "Too many knobs on one JSX tag" },
    { key: "confirmLabel", label: "confirmLabel", type: "string", default: "Continue" },
    { key: "cancelLabel", label: "cancelLabel", type: "string", default: "Go back" },
    { key: "width", label: "width", type: "string", default: "640px", placeholder: "e.g. 480px" },
    {
      key: "icon",
      label: "icon",
      type: "select",
    ...
    { key: "analyticsId", label: "analyticsId", type: "string", default: "demo-kitchen-sink" },
    { key: "testId", label: "testId", type: "string", default: "kitchen-sink-modal" },
    {
      key: "role",
      label: "role",
      type: "select",
