...
export function Spinner({ label, size = "md" }: Props) {
  ...
  return (
    <span role="status" className="inline-flex items-center gap-2 text-primary">
      <span
        className={`inline-block animate-spin rounded-full border-current border-t-transparent ${sizeClass[s]}`}
        aria-hidden
      />
