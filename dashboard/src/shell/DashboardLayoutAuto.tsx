...
function StaticPreviewUnavailableBanner() {
  return (
    <div
      ...
      role="status"
    >
      <strong className="font-medium">Governance only</strong> — live component
      previews are unavailable in the prebuilt dashboard. Run{" "}
      ...
      latest{" "}
      <code className="rounded bg-muted px-1 py-0.5 font-mono text-xs">dslinter</code>{" "}
