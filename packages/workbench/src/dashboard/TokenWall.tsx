          ...
          {catalog.colors.map((c) => (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="truncate font-mono text-xs text-neutral-400">{c.tw}</p>
              </div>
            </li>
          ))}
        </ul>
              ...
              <ul className="mt-3 grid gap-3 sm:grid-cols-2">
                {typo.families.map((f) => (
                  ...
                  >
                    ...
                    <p className="mt-2 truncate font-mono text-xs text-neutral-900">{f.tw}</p>
                    <p className="mt-1 break-all text-[11px] leading-snug text-neutral-500">{f.value}</p>
                  </li>
                ))}
              </ul>
            </div>
                ...
                <div key={family.key}>
                  ...
                  <ul className="mt-3 divide-y divide-neutral-100 overflow-x-auto rounded-lg border border-neutral-200 bg-white">
                    {typo.sizes.map((s) => (
                      ...
                      >
                        <span className="w-24 shrink-0 font-mono text-neutral-700">{s.tw}</span>
                        <span className="hidden w-36 shrink-0 text-neutral-500 sm:inline">{s.value}</span>
                        <span
                  ...
                  <ul className="mt-3 divide-y divide-neutral-100 overflow-x-auto rounded-lg border border-neutral-200 bg-white">
                    {typo.sizes.map((s) => (
                      ...
                      >
                        <span className="w-24 shrink-0 font-mono text-neutral-700">{s.tw}</span>
                        <span className="hidden w-36 shrink-0 text-neutral-500 sm:inline">{s.value}</span>
                        <span className={`min-w-0 flex-1 truncate font-sans ${s.tw} text-neutral-900`}>
                          Aa Bb Cc 0123456789
                        </span>
                      </li>
                    ))}
                ...
                <div key={`w-${family.key}`}>
                  ...
                  <ul className="mt-3 divide-y divide-neutral-100 rounded-lg border border-neutral-200 bg-white">
                    {weights.map((w) => (
                      ...
                      >
                        <span className="w-28 shrink-0 font-mono text-neutral-700">{w.tw}</span>
                  ...
                  <ul className="mt-3 divide-y divide-neutral-100 rounded-lg border border-neutral-200 bg-white">
                    {weights.map((w) => (
                      ...
                      >
                        ...
                        <span className={`min-w-0 flex-1 font-sans ${w.tw} text-base text-neutral-900`}>
                          Agile beige sharks vex polite judges.
                        </span>
                      </li>
                    ))}
