export function DefaultOverview() {
  return (
    <div className="min-h-0 flex-1 overflow-auto bg-gray-50">
      <header className="border-b border-gray-200 bg-white px-layout-lg py-layout-md">
        <h1 className="text-2xl font-bold tracking-tight text-gray-900">DSLint workbench</h1>
        <p className="mt-layout-xs text-gray-600">
      ...
      <div className="mx-auto max-w-3xl px-8 py-8 text-sm text-gray-600">
        <p>
          Component previews are listed from <code className="rounded bg-white px-1 py-0.5 font-mono text-xs ring-1 ring-gray-200">dslint-report.json</code>{" "}
          (<code className="rounded bg-white px-1 py-0.5 font-mono text-xs ring-1 ring-gray-200">playgrounds</code>), built by the Rust scanner from your
          source files and <code className="rounded bg-white px-1 py-0.5 font-mono text-xs ring-1 ring-gray-200">playground_groups</code> in{" "}
